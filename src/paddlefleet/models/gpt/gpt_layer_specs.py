...
def get_attention_spec(
    ...
    use_mla_extra_norm = getattr(config, "use_mla_extra_norm", False)
    ...
    if attention_layer_type == "self_attention":
        ...
        return LayerSpec(
            ...
            sublayers_spec=MLASelfAttentionSublayersSpec(
                ...
                rope_norm=qk_norm_standard if use_mla_extra_norm else None,
                v_norm=qk_norm_standard if use_mla_extra_norm else None,
